                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-header bg-success" style=" color:white;">
                                    <h3 class="text-center font-weight-light my-4">숙소 사진 삭제</h3>
                                </div>
                                	...
                                	<c:otherwise>
		                                <c:forEach var="attach" items="${list}">
		                                	<div class="mt-4 mb-0" >
		                                	 ...
		                                	 <div class="d-grid">
		                                            <a href="${root}/admin/stay_file_delete?attachmentNo=${attach.attachmentNo}" class="btn btn-danger">삭제</a>
		                                     </div>
		                                </c:forEach>
                                	</c:otherwise>
                                </c:choose>
                            	...
                            	<div class="mt-4 mb-0">
                                        <div class="d-grid">
                                            <a href="${root}/admin/stay_list" class="btn btn-primary">돌아가기</a>
                                        </div>
                                </div>
                            </div>
                            </div>
