			...
			<div class="place_content">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="place_round_btn_container">
						<a href="${root}/review/write/${info.fieldName}"
							id="round_review_write_btn">라운드 후기 보기</a> <a
							href="${root}/booking/detail?fieldNo=${info.fieldNo}&teeTimeD=2022-07-30"
							id="round_review_show_btn">예약하러 가기</a>
					</div>
