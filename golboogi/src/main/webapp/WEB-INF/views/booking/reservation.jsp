		...
		<div class="modal-content">
			<div class="row">
				...
				<div class="col-4 text-right">
					<button class="btn-cancel" @click="hidden1=true"><i class="fa-solid fa-xmark"></i></button>
				</div>
			</div>
			<div class="row mt-2">
				<textarea>
	...
	<!-- <div class="modal-overlay"> -->
		<div class="modal-content">
			<div class="row">
				...
				<div class="col-4 text-right">
					<button class="btn-cancel" @click="hidden2=true"><i class="fa-solid fa-xmark"></i></button>
				</div>
			</div>
			<div class="row mt-2">
				<textarea>
	...
	<!-- <div class="modal-overlay"> -->
		<div class="modal-content">
			<div class="row">
				...
				<div class="col-4 text-right">
					<button class="btn-cancel" @click="hidden3=true"><i class="fa-solid fa-xmark"></i></button>
				</div>
			</div>
			<div class="row mt-2">
			<textarea>
